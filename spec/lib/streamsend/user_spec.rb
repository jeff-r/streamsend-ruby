    ...
    describe ".update" do
      ...
      describe "with a valid user" do
        it "should be successful" do
          response = StreamSend::User.update(@user_hash)
      ...
      describe "with valid user parameters" do
        describe "with an existing users" do
          ...
          it "should return the new user's id" do
            user_id = StreamSend::User.create({"account_id" => 1, "email_address" => "foo@bar.com", "first_name" => "JoeBob"})
